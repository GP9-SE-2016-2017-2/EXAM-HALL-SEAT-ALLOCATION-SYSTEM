...
<div class="row container">
  ...
  while ($row = mysql_fetch_array($query)) {
    echo "<tr>
          ...
          <td>".$row['name']."</td>
          <td>".$row['capacity']."</td>
          <td><a href='hall?id=".$row[0]."'><button type='button' class='btn btn-danger btn-sm '>Delete</button></a></td>
          <td><a href='edithall?edit=$row[id]'><button type='button' class='btn btn-default btn-sm'>Edit</button></a></td>
          </tr>";
  }
