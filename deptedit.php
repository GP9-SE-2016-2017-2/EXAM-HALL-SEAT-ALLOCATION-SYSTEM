...
include_once("connect.php");
 ...
 if( isset($_GET['edit']))
     {
             $id = $_GET['edit'];
             $res = mysql_query("SELECT * FROM dept WHERE ID='$id'");
     ...
     { 
              $id = $_POST['id'];
               $UpdateQuery = "UPDATE dept SET deptid ='$_POST[did]', name='$_POST[name]' WHERE ID='$id'";
...
<div class="row container">
  ...
  <div class="col-xs-6 space">
    ...
    <form class="myform" action="deptedit" method="post">
  Dept ID:<br><input type="text" required="required" name="did" value="<?php echo $row[1]; ?>"><br>
  Name:<br><input type="text" required="required" name="name" value="<?php echo $row[2]; ?>"><br><br>
  <input type="hidden" name="id" value="<?php echo $row[0]; ?>">
  <input class="btn btn-default" type="submit" value="Update" name="submit">
  <a class="btn btn-default" href="dept" role="button">Cancel</a>
</form>
  </div>
</div>
