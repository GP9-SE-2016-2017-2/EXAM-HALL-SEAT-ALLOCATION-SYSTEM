...
<div class="row container">
  ...
  Course Code:<br><input type="text" readonly="readonly" name="cid" value="<?php echo $row[1]; ?>"><br>
  Name:<br><input type="text" readonly="readonly" name="name" value="<?php echo $row[2]; ?>"><br>
...
echo "Hall:<br>";
 ...
 <br>
  <input class="btn btn-default" type="submit" value="Allocate" name="submit">
